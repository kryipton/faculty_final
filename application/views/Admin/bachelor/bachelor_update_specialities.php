...
<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" style="display: inline-block; float: left;">
    <div class="row">
        ...
        <div class="right">
            ...
            <form action="<?php echo base_url('himalaY_bakalavr_ixtisas_yenileme/') . $speciality["bachelor_id"] ?>" method="POST">
                ...
                <div class="tab-content" style="margin-top: 30px">
                    ...
                    <div id="az" class="tab-pane fade in active">
                        ...
                        <input value="<?php echo $speciality["bachelor_text"]?>" type="text" class="form-control" name="speciality_code"><br>

                        <label for="">İxtisasın adı</label>
                        <input value="<?php echo $speciality["bachelor_text_about_az"]?>" type="text" class="form-control" name="speciality_name_az"><br>
                        <br>
                        ...
                        <textarea style="resize: none" class="form-control ckeditor" name="speciality_about_az" id="" cols="30" rows="10" placeholder="">
                            <?php echo $speciality["bachelor_text_text_az"]?>
                        </textarea><br>
                    ...
                    <div id="ru" class="tab-pane fade">
                        ...
                        <label for="">İxtisasın adı</label>
                        <input value="<?php echo $speciality["bachelor_text_about_ru"]?>" type="text" class="form-control" name="speciality_name_ru"><br>
                        <br>

                        <label for="">İxtisas Haqqında</label>
                        <textarea style="resize: none" class="form-control ckeditor" name="speciality_about_ru" id="" cols="30" rows="10" placeholder="">
                            <?php echo $speciality["bachelor_text_text_ru"]?>
                        </textarea><br>
                    ...
                    <div id="en" class="tab-pane fade">
                        ...
                        <label for="">İxtisasın adı</label>
                        <input value="<?php echo $speciality["bachelor_text_about_en"]?>" type="text" class="form-control" name="speciality_name_en"><br>
                        <br>

                        <label for="">İxtisas Haqqında</label>
                        <textarea style="resize: none" class="form-control ckeditor" name="speciality_about_en" id="" cols="30" rows="10" placeholder="">
                            <?php echo $speciality["bachelor_text_text_en"]?>
                        </textarea><br>
