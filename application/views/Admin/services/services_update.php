...
<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" style="display: inline-block; float: left;">
    <div class="row">
        ...
        <div class="right">
            ...
            <form action="<?php echo base_url("himalaY_xidmetler_yenilenmesi/$service[id]") ?>" method="POST">
                ...
                <div class="tab-content" style="margin-top: 30px">
                    ...
                    <input type="text" class="form-control" name="name_az" value="<?php echo $service["name_az"]?>"><br>
                    <br>

                    <label for="">Xidmətin Adı EN</label>
                    <input type="text" class="form-control" name="name_en" value="<?php echo $service["name_en"]?>"><br>
                    <br>

                    <label for="">Xidmətin Adı RU</label>
                    <input type="text" class="form-control" name="name_ru" value="<?php echo $service["name_ru"]?>"><br>
                    <br>

                    <label for="">Xidmətin linki</label>
                    <input type="text" class="form-control" name="link" value="<?php echo $service["link"]?>"><br>
                    <br>
