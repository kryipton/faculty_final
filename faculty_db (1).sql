...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2019 at 04:44 PM
...
--
-- Table structure for table `phd_about_text`
--
...
--
-- Dumping data for table `phd_about_text`
--
...
--
-- Table structure for table `phd_speciality_db`
--
...
--
-- Dumping data for table `phd_speciality_db`
--
...
CREATE TABLE `slide` (
  ...
  `slide_desc` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `slide` (`slide_id`, `slide_image`, `slide_title`, `slide_desc`, `slide_link`) VALUES
(8, '408888-black-blue-wallpaper.jpg', ' ', '', ' '),
(9, '678405.jpg', 'aqsa', '<p>asasasas</p>\r\n', 'sasasas'),
(10, '2014_Koenigsegg_Agera_One_Car_Vehicle_Sport_Supercar_Sportcar_Supersport_4000x3000__5__4000x3000.jpg', 'asdasdasd', '<p>dasdasdaa</p>\r\n', 'dasdasda');
...
--
-- Indexes for table `phd_about_text`
--
ALTER TABLE `phd_about_text`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `phd_speciality_db`
--
...
--
-- AUTO_INCREMENT for table `phd_about_text`
--
ALTER TABLE `phd_about_text`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `phd_speciality_db`
--
ALTER TABLE `phd_speciality_db`
