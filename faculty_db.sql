...
(31, 'Screenshot_(1).png', 'az', 'en', 'ru', '<p>az</p>\r\n', 'en', 'ru', '');
...
--
ALTER TABLE `doctorate_speciality_db`
  MODIFY `doctorate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
